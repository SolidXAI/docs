...
`solid-api` is where SolidX code generation is most active. Metadata drives the creation and maintenance of:
...
- entities,
- repositories,
- and model-related layout metadata.

### `solid-ui`

`solid-ui` is not auto-generated model-by-model in the same way. Instead, projects follow a convention-based structure:
...
- and each UI module can contribute routes, Redux pieces, extension functions, and extension components.
...
This is the recommended command for most day-to-day workflows.

It generates or refreshes code for an entire module and all of its models.
...
Use this when you want a smaller, more targeted refresh for a single model and its related models.
