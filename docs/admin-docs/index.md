...
### [Layout Editor](./layouts/index.md)
Use a metadata driven layout editor to control the different user interfaces generated by SolidX.

### [Modules](./modules/index.md)
Here we talk about the various features of the modules that you have generated using the Module Builder & the Layout Editor. We will look at the core functionality available to every module out of the box.
