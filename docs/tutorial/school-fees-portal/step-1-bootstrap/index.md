...
![Create Solid App](/img/tutorial/school-fees-portal/school-fees-setup-bootstrap.png)
...
> After you run `solid seed` a default admin user will be configured the password of which will be printed on the terminal
