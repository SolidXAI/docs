...
const InstituteActivateById = (action: any) => {
  ...
  const footerContent = (
    <div>
      <Button className='p-button p-component p-button-sm' label="Ok" icon="pi pi-check" onClick={activateInstitute} />
      <Button className='bg-primary-reverse p-button p-component p-button-outlined p-button-sm' label="Cancel" icon="pi pi-times" onClick={() => dispatch(closePopup())} />
    </div>
  );
    ...
    <>
      ...
      >
        <div className="flex flex-column gap-4 ">
          <p className='m-0'>Clicking Ok below will activate and host this institute, are you sure you want to continue?</p>
        </div>
      </Dialog>
    </>
  );
...
const InstituteDeactivateById = (action: any) => {
  ...
  const footerContent = (
    <div>
      <Button className='p-button p-component p-button-sm' label="Ok" icon="pi pi-check" onClick={deactivateInstitute} />
      <Button className='bg-primary-reverse p-button p-component p-button-outlined p-button-sm' label="Cancel" icon="pi pi-times" onClick={() => dispatch(closePopup())} />
    </div>
  );
  ...
  return (
    <>
      ...
      >
        <div className="flex flex-column gap-4 ">
          <p className='m-0'>Clicking Ok below will Deactivate this institute, are you sure you want to continue?</p>
        </div>
      </Dialog>
    </>
  );
