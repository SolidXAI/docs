...
<Callout type="note" title="Required Status Field">
...
<Tabs defaultValue="readonly">
  <TabItem value="readonly" label="Read-only Indicator">
  ...
  <TabItem value="updatable" label="Updatable Indicator">
