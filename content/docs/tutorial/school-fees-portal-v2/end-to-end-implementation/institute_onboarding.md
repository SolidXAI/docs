...
|-------|-----------|-------------|-------------|
| **Part Payment Allowed** | Yes | Can students pay in installments? | • Select **Yes** for expensive fees (like tuition)• Select **No** for smaller fees that should be paid in full |
...
|-------|-----------|-------------|-------------------|
| **Late Payment Fees Type** | No | How to calculate late fees | • **None**: No penalty• **Percent**: Percentage of amount (e.g., 5% of ₹10,000 = ₹500)• **Absolute**: Fixed amount (e.g., ₹100 flat fee) |
| **Late Payment Fees** | No | The fee amount or percentage | • If Percent: Enter 5 (for 5%)• If Absolute: Enter 100 (for ₹100) |
...
|-------|-----------|-------------|---------|
| **User Type** | Yes | What role should this user have? | • **Institute Admin**• **Platform Admin** |
