...
import { List, MessageSquare, Upload, Download, Eye } from 'lucide-react';
...
<Cards>
  <Card icon={<List />} title="Manage Reusable Value Lists">
...
<Cards>
  <Card icon={<MessageSquare />} title="Track System Messages">
...
<Cards>
  <Card icon={<MessageSquare />} title="Monitor Job Queues">
    - Monitor job queues
    - Track job status
    - View error details
    - Retry failed jobs
...
<Cards>
  <Card icon={<Upload />} title="Track Import Progress">
...
<Cards>
  <Card icon={<Download />} title="Configure Exports">
    - Configure exports
    - Format options
    - Schedule exports
    - Delivery options
...
<Cards>
  <Card icon={<Eye />} title="Save Custom Views">
    - Save custom views
    - Share with teams
    - Set defaults
    - Manage permissions
