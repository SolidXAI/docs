...
<Cards>
  ...
  <Card title="Timeouts and Waiting" href="/docs/developer-docs/testing/timeouts">
    Change how long steps wait when the defaults are not right for your application.
  </Card>
</Cards>
