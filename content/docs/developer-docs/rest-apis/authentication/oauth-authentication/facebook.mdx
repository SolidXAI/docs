...
<Steps>
  <Step>
    **User clicks the Facebook sign-in button** in the application.
  </Step>
  <Step>
    **The application redirects to Facebook's login page** for authentication.
  </Step>
  <Step>
    **User logs in with their Facebook account** and grants the application permission to access their email and profile.
  </Step>
  <Step>
