...
See also: [Redux Module Integration](/docs/developer-docs/extending/frontend-customization/redux-module-integration)
...
<Accordion title="getSolidEntities">
...
<Accordion title="getSolidEntityById">
...
Prefer direct HTTP helpers when the workflow is custom, multi-step, or not entity-shaped. See [Solid HTTP API](/docs/developer-docs/extending/frontend-customization/solid-http-api).
