...
Use this option when the kanban card widget belongs to a module-owned API strategy and should participate in shared cached state, invalidation, or coordinated refresh flows.
