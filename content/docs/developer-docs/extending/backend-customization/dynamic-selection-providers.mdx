...
summary: Covers provider-backed runtime option resolution, field metadata wiring, `ISelectionProvider` implementation, provider context, and registration.
...
<Callout type="info" title="Tip">
  - SolidX ships with built-in providers for common use cases - see [Built-in Selection Providers](/docs/developer-docs/extending/reference/built-in-selection-providers) for details on **`ListOfValuesSelectionProvider`** and **`PseudoForeignKeySelectionProvider`**.
...
<Callout type="note" title="Deprecated Method">
...
<details open>
 <summary>Example: <code>StockApiSelectionProvider</code></summary>
