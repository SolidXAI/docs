...
summary: Covers service-level backend customization for SolidX, including custom business operations, service design, and integration with controllers and jobs.
...
## Extending the Generated Service Layer
...
See the [Extending Controllers](/docs/developer-docs/extending/backend-customization/extending-controllers) guide for details on adding endpoints.
