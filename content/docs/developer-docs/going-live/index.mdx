...
Whichever path you take, see [Redis](/docs/developer-docs/going-live/redis-configuration) for the memory settings recommended on the instance backing SolidX sessions and cache.
